<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UserSignUp.aspx.cs" Inherits="ResturantManagement1.UserSignUp" %>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="50px" src="imgs/usericon.jpg" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <asp:Button ID="Button1" class="btn btn-primary btn-block "  runat="server" Text="Sign Up" OnClick="Button1_Click"  />
                                </div>
                            </div>
                        </div>
