...
namespace ResturantManagement1
{
    public partial class Site1 : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Session["role"].Equals(""))
                {
                    ...
                    LinkButton11.Visible = false; // chef management link button
                    
                    LinkButton8.Visible = false; // product inventory link button
                    LinkButton9.Visible = false; // orders link button
                ...
                else if (Session["role"].Equals("user"))
                {
                    ...
                    LinkButton6.Visible = true; // admin login link button
                    LinkButton11.Visible = false; // chefs link button
                ...
                else if (Session["role"].Equals("admin"))
                {
                    ...
                    LinkButton11.Visible = true; // chef management link button
                   
                    LinkButton8.Visible = true; // product inventory link button
                    LinkButton9.Visible = true; // orders link button
        ...
        //{
        //    Response.Redirect("table_booking.aspx");
        //}
